...
_G.packer_plugins = {
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/vim-airline",
